...
impl FileContextJavaScript {
    ...
    pub fn update_state(&mut self, _scope: &mut HandleScope, tree: &tree_sitter::Tree, code: &str) {
    ...
    ) -> Result<MirroredVec<PackageImport, JSPackageImport<Class>>, DDSAJsRuntimeError> {
